...
function bndtls_settings_layout_title( $meta_boxes ) {
	...
	$fields = [
		...
		[
			'name'              => _x( 'Shortcode defaults', 'layout-settings', 'band-tools' ),
			'id'                => $prefix . 'record_default',
			'type'              => 'checkbox_list',
			'label_description' => _x( 'Default settings for widget and shortcode', 'layout-settings', 'band-tools' ),
			'options'           => [
				'poster'							=> _x( 'Show record thumbnail', 'layout-settings', 'band-tools' ),
				'title'							=> _x( 'Show record title', 'layout-settings', 'band-tools' ),
				'band'							=> _x( 'Show band', 'layout-settings', 'band-tools' ),
				'info'							=> _x( 'Show record info (release, type, genre)', 'layout-settings', 'band-tools' ),
				'tracks'							=> _x( 'Show record tracks', 'layout-settings', 'band-tools' ),
				'player'							=> _x( 'Show player', 'layout-settings', 'band-tools' ),
			],
			'std'               => [ false, false, true, false, true, true ],
			// 'readonly'          => true,
			// 'disabled'          => true,
			'select_all_none'   => true,
		],
