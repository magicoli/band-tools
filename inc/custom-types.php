...
function bndtls_register_my_cpts() {
	...
	$labels = [
		...
		"featured_image" => __( "Featured image for this Band", "band-tools" ),
		"set_featured_image" => __( "Set featured image for this Band", "band-tools" ),
		"remove_featured_image" => __( "Remove featured image for this Band", "band-tools" ),
		"use_featured_image" => __( "Use as featured image for this Band", "band-tools" ),
	...
	$labels = [
		...
		"featured_image" => __( "Featured image for this Album", "band-tools" ),
		"set_featured_image" => __( "Set featured image for this Album", "band-tools" ),
		"remove_featured_image" => __( "Remove featured image for this Album", "band-tools" ),
		"use_featured_image" => __( "Use as featured image for this Album", "band-tools" ),
	...
	$labels = [
		...
		"featured_image" => __( "Featured image for this Song", "band-tools" ),
		"set_featured_image" => __( "Set featured image for this Song", "band-tools" ),
		"remove_featured_image" => __( "Remove featured image for this Song", "band-tools" ),
		"use_featured_image" => __( "Use as featured image for this Song", "band-tools" ),
