...
// dirty fast tweak to get the genres list. Should be possible (and better) to
// get it  from wp core functions but I can't figure it out and I need to move
// on

function bndtls_id3_genres($allowSCMPXextended=true) {
